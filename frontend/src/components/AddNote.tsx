...
const AddNote = () => {
  ...
  return (
    <div>
      <button className='btn btn-circle justify-center items-center flex bg-red-800 text-white' onClick={()=>(document.getElementById('add_note_modal') as HTMLDialogElement).showModal()}>
